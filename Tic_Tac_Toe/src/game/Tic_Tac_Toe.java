	...
	public static void main(String[] args) {
		...
		while(turn < 10) {
			if(turn % 2 != 0) {
				...
				System.out.printf("\nPlayer 1 turn. Choose the house number you want to dial: ");
				play = kb.nextInt();
				for (i = 0; i < 50; ++i)  
				       System.out.println();
				
				if(play == 1 && ticTacToe[0][0] == 0 && ticTacToe[0][0] != 2) {
					matrix[0][0] = "X";
					ticTacToe[0][0] = 1; 
				}
				else if(play == 2 && ticTacToe[0][1] == 0 && ticTacToe[0][1] != 2) {
					matrix[0][1] = "X";
					ticTacToe[0][1] = 1;
				}
				else if(play == 3 && ticTacToe[0][2] == 0 && ticTacToe[0][2] != 2) {
					matrix[0][2] = "X";
					ticTacToe[0][2] = 1;
				}
				else if(play == 4 && ticTacToe[1][0] == 0 && ticTacToe[1][0] != 2) {
					matrix[1][0] = "X";
					ticTacToe[1][0] = 1;
				}
				else if(play == 5 && ticTacToe[1][1] == 0 && ticTacToe[1][1] != 2) {
					matrix[1][1] = "X";
					ticTacToe[1][1] = 1;
				}
				else if(play == 6 && ticTacToe[1][2] == 0 && ticTacToe[1][2] != 2) {
					matrix[1][2] = "X";
					ticTacToe[1][2] = 1;
				}
				else if(play == 7 && ticTacToe[2][0] == 0 && ticTacToe[2][0] != 2) {
					matrix[2][0] = "X";
					ticTacToe[2][0] = 1;
				}
				else if(play == 8 && ticTacToe[2][1] == 0 && ticTacToe[2][1] != 2) {
					matrix[2][1] = "X";
					ticTacToe[2][1] = 1;
				}
				else if(play == 9 && ticTacToe[2][2] == 0 && ticTacToe[2][2] != 2) {
				matrix[2][2] = "X";
				ticTacToe[2][2] = 1;
				}
			}
					...
					System.out.printf("	[%s][%s][%s]		|	[4][5][6]\n",matrix[1][0], matrix[1][1], matrix[1][2]);
					System.out.printf("	[%s][%s][%s]		|	[7][8][9]\n", matrix[2][0], matrix[2][1], matrix[2][2]);
					System.out.printf("\nPlayer 2 turn. Choose the house number you want to dial: ");
					play = kb.nextInt();
					for (i = 0; i < 50; ++i)  
					       System.out.println(); 
					
					if(play == 1 && ticTacToe[0][0] == 0 && ticTacToe[0][0] != 1) {
						matrix[0][0] = "O";
						ticTacToe[0][0] = 2; 
					}
					else if(play == 2 && ticTacToe[0][1] == 0 && ticTacToe[0][1] != 1) {
						matrix[0][1] = "O";
						ticTacToe[0][1] = 2;
					}
					else if(play == 3 && ticTacToe[0][2] == 0 && ticTacToe[0][2] != 1) {
						matrix[0][2] = "O";
						ticTacToe[0][2] = 2;
					}
					else if(play == 4 && ticTacToe[1][0] == 0 && ticTacToe[1][0] != 1) {
						matrix[1][0] = "O";
						ticTacToe[1][0] = 2;
					}
					else if(play == 5 && ticTacToe[1][1] == 0 && ticTacToe[1][1] != 1) {
						matrix[1][1] = "O";
						ticTacToe[1][1] = 2;
					}
					else if(play == 6 && ticTacToe[1][2] == 0 && ticTacToe[1][2] != 1) {
						matrix[1][2] = "O";
						ticTacToe[1][2] = 2;
					}
					else if(play == 7 && ticTacToe[2][0] == 0 && ticTacToe[2][0] != 1) {
						matrix[2][0] = "O";
						ticTacToe[2][0] = 2;
					}
					else if(play == 8 && ticTacToe[2][1] == 0 && ticTacToe[2][1] != 1) {
						matrix[2][1] = "O";
						ticTacToe[2][1] = 2;
					}
					else if(play == 9 && ticTacToe[2][2] == 0 && ticTacToe[2][2] != 1) {
					matrix[2][2] = "O";
					ticTacToe[2][2] = 2;
					}
				}
